...
st.set_page_config(page_title='HDB Flat Resale Price Predictor',page_icon='house',initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by R.Saravanan'})
...
if selected == "About":
    ...
    st.markdown('''**Hello! I'm Saravanan, a MBA graduate with a keen interest in data science and analytics.
                Currently on an exciting journey into the world of data science...**''')
    st.link_button('Linkedin','https://www.linkedin.com/in/saravanan-r-864489208/') 